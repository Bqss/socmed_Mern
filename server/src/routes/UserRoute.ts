import { followUser, getAllUser, getUserById, getUserCrediental, getUserFollower, unfollowUser, updateUser } from './../controllers/UserController.js';
...
UserRoute.get("/followers",authMiddleware,getUserFollower);
